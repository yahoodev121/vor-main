...
import SessionTimeout from 'src/mui/shared/SessionTimeout';
...
import AIConfigurator from 'src/mui/shared/AIConfigurator';
...
function AppWithSnackbar(props) {
  ...
  const handleOnMouseEnter = () => {
    if (miniSidenav4View && !onMouseEnter) {
      dispatch(muiActions.doMiniSidenav4View(false));
