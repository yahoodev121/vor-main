...
import PolicyTemplateCard from 'src/view/policyTemplate/list/PolicyTemplateCard';
...
function PolicyTemplateListTable(props) {
  ...
  const handleOpenCreateTask = (policyTemplate) => {
    setVisibleTaskModal(policyTemplate);
  };
  ...
  const handleOpenCreateRisk = (policyTemplate) => {
    setVisibleRiskModal(policyTemplate);
  };
                        ...
                        {hasPermissionToEdit && (
                          ...
                          >
                            <IconButton
                              ...
                              color={sidenavColor}
                              component={Link}
                              to={`/policy-template/${row.id}/edit`}
                            >
                              <EditIcon />
                            </IconButton>
                          </Tooltip>
    ...
    <>
      ...
      {Boolean(visibleTaskModal) && (
        <TaskFormModal
          ...
          policyTemplates={visibleTaskModal}
      ...
      {Boolean(visibleRiskModal) && (
        <RiskFormModal
          ...
          policyTemplates={visibleRiskModal}
        />
      )}
    </>
  );
...
export default PolicyTemplateListTable;
