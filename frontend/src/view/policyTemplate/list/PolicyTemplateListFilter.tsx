...
const previewRenders = {
  ...
  lastUpdatedRange: {
    label: i18n(
      'entities.policyTemplate.fields.lastUpdatedRange',
    ),
  ...
  favorites: {
    label: i18n('entities.policyTemplate.fields.favorites'),
...
function PolicyTemplateListFilter(props) {
...
export default PolicyTemplateListFilter;
