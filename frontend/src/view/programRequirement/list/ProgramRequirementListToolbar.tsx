...
function ProgramRequirementToolbar(props) {
  ...
  const hasPermissionToImport = useSelector(
    programRequirementSelectors.selectPermissionToImport,
  );
    ...
    <ToolbarWrapper>
      ...
      {hasPermissionToImport && (
        <MDButton
          ...
          color={sidenavColor}
          component={Link}
          to="/program-requirement/importer"
      ...
      {hasPermissionToAuditLogs && (
        <MDButton
          ...
          color={sidenavColor}
          component={Link}
          to="/audit-logs?entityNames=programRequirement"
...
export default ProgramRequirementToolbar;
