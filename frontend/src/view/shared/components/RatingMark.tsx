...
export function getRatingMarkForeColor(color) {
  if (!color) {
    return null;
  }
...
export function getRatingMarkBackColor(color) {
  if (!color) {
    return null;
  }
...
function RatingMark(props) {
  ...
  const backColor = getRatingMarkBackColor(mainColor);
  const foreColor = getRatingMarkForeColor(mainColor);
