...
import PolicyCard from 'src/view/policy/list/PolicyCard';
...
function PolicyListTable(props) {
  ...
  const doDestroy = (id) => {
    ...
    dispatch(destroyActions.doDestroyAll([id]));
  };
