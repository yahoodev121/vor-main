...
const schema = yup.object().shape({
  referenceRange: yupFilterSchemas.integerRange(
    i18n('entities.project.fields.referenceRange'),
  ),
  ...
  status: yupFilterSchemas.relationToOne(
  ...
  dueDateRange: yupFilterSchemas.datetimeRange(
    i18n('entities.project.fields.dueDateRange'),
  ),
});
...
const previewRenders = {
  referenceRange: {
    label: i18n('entities.project.fields.referenceRange'),
  ...
  dueDateRange: {
    label: i18n('entities.project.fields.dueDateRange'),
              ...
              <Grid container spacing={1.6}>
                <Grid item lg={6} xs={12}>
                  <InputNumberRangeFormItem
                    name="referenceRange"
                    label={i18n(
                      'entities.project.fields.referenceRange',
                    )}
                    variant="standard"
                  />
                </Grid>
                ...
                <Grid item lg={6} xs={12}>
                  <DatePickerRangeFormItem
                    name="dueDateRange"
                    label={i18n(
                      'entities.project.fields.dueDateRange',
                    )}
                    variant="standard"
                    showTime
                  />
...
ProjectListFilter.defaultProps = {
  relation: '',
