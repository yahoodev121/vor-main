...
function ProgramControlTemplateToolbar(props) {
  ...
  const hasPermissionToCreate = useSelector(
    programControlTemplateSelectors.selectPermissionToCreate,
  );
  const hasPermissionToImport = useSelector(
    programControlTemplateSelectors.selectPermissionToImport,
  );
    ...
    <ToolbarWrapper>
      {hasPermissionToCreate && (
        <MDButton
          ...
          color={sidenavColor}
          component={Link}
          to="/program-control-template/new"
          startIcon={<AddIcon />}
          size="small"
        >
          {i18n('common.new')}
      ...
      {hasPermissionToImport && (
        <MDButton
          ...
          color={sidenavColor}
          component={Link}
          to="/program-control-template/importer"
      ...
      {hasPermissionToAuditLogs && (
        <MDButton
          ...
          color={sidenavColor}
          component={Link}
          to="/audit-logs?entityNames=programControlTemplate"
...
export default ProgramControlTemplateToolbar;
