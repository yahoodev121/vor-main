...
function ProgramControlTemplateViewToolbar(props) {
  ...
  return (
    <ToolbarWrapper>
      {hasPermissionToEdit && (
        <MDButton
          component={Link}
          to={`/program-control-template/${id}/edit`}
          variant="gradient"
          color={sidenavColor}
          type="button"
          startIcon={<EditIcon />}
...
export default ProgramControlTemplateViewToolbar;
