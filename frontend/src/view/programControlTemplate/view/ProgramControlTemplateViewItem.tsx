...
import selectors from 'src/modules/programControlTemplate/programControlTemplateSelectors';

function ProgramControlTemplateViewItem(props) {
    ...
    if (
      ...
      return (
        <MDBox key={record.id}>
          <MaterialLink
            component={Link}
            to={`/program-control-template/${record.id}`}
          >
...
ProgramControlTemplateViewItem.defaultProps = {
  hiddenLabel: false,
};

ProgramControlTemplateViewItem.propTypes = {
  label: PropTypes.string,
  value: PropTypes.any,
  hiddenLabel: PropTypes.bool,
};

export default ProgramControlTemplateViewItem;
