...
import actions from 'src/modules/projectPriority/form/projectPriorityFormActions';
import MDBox from 'src/mui/components/MDBox';
import MDTypography from 'src/mui/components/MDTypography';
import ProjectPriorityForm from 'src/view/projectPriority/form/ProjectPriorityForm';
import selectors from 'src/modules/projectPriority/form/projectPriorityFormSelectors';
import Spinner from 'src/view/shared/Spinner';

function ProjectPriorityFormPage(props) {
...
export default ProjectPriorityFormPage;
