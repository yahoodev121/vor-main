...
function ProjectPriorityListTable(props) {
  ...
  const hasPermissionToEdit = useSelector(
    projectPrioritySelectors.selectPermissionToEdit,
  );
            ...
            {!loading &&
              rows.map((row) => (
                <TableRow key={row.id}>
                      ...
                      {hasPermissionToEdit && !row.system && (
                        ...
                        >
                          <IconButton
                            ...
                            color={sidenavColor}
                            component={Link}
                            to={`/project-priority/${row.id}/edit`}
                          >
                            <EditIcon />
                          </IconButton>
                        </Tooltip>
                  ...
                  <DataTableBodyCell>
                    <ProjectPriorityListItem value={row} />
                  </DataTableBodyCell>
                </TableRow>
              ))}
          </TableBody>
...
export default ProjectPriorityListTable;
