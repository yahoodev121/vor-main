...
import actions from 'src/modules/projectPriority/importer/projectPriorityImporterActions';
...
function ProjectPriorityImportPage() {
  const Importer = importerHoc(
    selectors,
    actions,
    fields,
    i18n('entities.projectPriority.importer.hint'),
  );
...
export default ProjectPriorityImportPage;
