...
import actions from 'src/modules/program/importer/programImporterActions';
...
function ProgramImportPage() {
  const Importer = importerHoc(
    selectors,
    actions,
    fields,
    i18n('entities.program.importer.hint'),
  );
...
export default ProgramImportPage;
