...
import ProgramListFilter from 'src/view/program/list/ProgramListFilter';
import ProgramListTable from 'src/view/program/list/ProgramListTable';
import ProgramListToolbar from 'src/view/program/list/ProgramListToolbar';
        ...
        <MDBox pt={2.4} px={2.4} topBorder>
          ...
          >
            <MDTypography variant="h3">
              {i18n('entities.program.list.title')}
            </MDTypography>
            <ProgramListToolbar />
          </MDBox>
          <ProgramListFilter />
