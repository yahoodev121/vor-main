...
import actions from 'src/modules/projectType/importer/projectTypeImporterActions';
...
function ProjectTypeImportPage() {
  const Importer = importerHoc(
    selectors,
    actions,
    fields,
    i18n('entities.projectType.importer.hint'),
  );
...
export default ProjectTypeImportPage;
