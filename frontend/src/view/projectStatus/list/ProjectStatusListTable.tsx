...
function ProjectStatusListTable(props) {
  ...
  const hasPermissionToEdit = useSelector(
    projectStatusSelectors.selectPermissionToEdit,
  );
            ...
            {!loading &&
              rows.map((row) => (
                <TableRow key={row.id}>
                  ...
                  <DataTableBodyCell>
                    <ProjectStatusListItem value={row} />
                  </DataTableBodyCell>
                </TableRow>
              ))}
          </TableBody>
...
export default ProjectStatusListTable;
