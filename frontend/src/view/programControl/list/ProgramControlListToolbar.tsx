...
function ProgramControlToolbar(props) {
  ...
  const hasPermissionToImport = useSelector(
    programControlSelectors.selectPermissionToImport,
  );
    ...
    <ToolbarWrapper>
      ...
      {hasPermissionToAuditLogs && (
        <MDButton
          ...
          color={sidenavColor}
          component={Link}
          to="/audit-logs?entityNames=programControl"
...
export default ProgramControlToolbar;
