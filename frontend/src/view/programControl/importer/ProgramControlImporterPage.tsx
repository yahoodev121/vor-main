...
import actions from 'src/modules/programControl/importer/programControlImporterActions';
...
function ProgramControlImportPage() {
  const Importer = importerHoc(
    selectors,
    actions,
    fields,
    i18n('entities.programControl.importer.hint'),
  );
...
export default ProgramControlImportPage;
