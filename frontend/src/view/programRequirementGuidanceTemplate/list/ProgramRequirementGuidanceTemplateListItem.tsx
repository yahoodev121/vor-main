...
function ProgramRequirementGuidanceTemplateListItem(props) {
...
ProgramRequirementGuidanceTemplateListItem.propTypes = {
  value: PropTypes.any,
};

export default ProgramRequirementGuidanceTemplateListItem;
