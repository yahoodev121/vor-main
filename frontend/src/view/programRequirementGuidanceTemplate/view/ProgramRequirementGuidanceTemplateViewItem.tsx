...
function ProgramRequirementGuidanceTemplateViewItem(props) {
    ...
    if (
      ...
      return (
        <MDBox key={record.id}>
          <MaterialLink
            component={Link}
            to={`/program-requirement-guidance-template/${record.id}`}
          >
...
ProgramRequirementGuidanceTemplateViewItem.defaultProps = {
  hiddenLabel: false,
};

ProgramRequirementGuidanceTemplateViewItem.propTypes = {
  label: PropTypes.string,
  value: PropTypes.any,
  hiddenLabel: PropTypes.bool,
};

export default ProgramRequirementGuidanceTemplateViewItem;
