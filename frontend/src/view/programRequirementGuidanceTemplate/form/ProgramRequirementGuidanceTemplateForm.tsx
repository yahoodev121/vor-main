...
import EditProgramRequirementGuidanceTemplateLayout from 'src/view/programRequirementGuidanceTemplate/form/EditProgramRequirementGuidanceTemplateLayout';
...
import NewProgramRequirementGuidanceTemplateLayout from 'src/view/programRequirementGuidanceTemplate/form/NewProgramRequirementGuidanceTemplateLayout';
...
const schema = yup.object().shape({
  ...
  productCategories: yupFormSchemas.relationToMany(
    i18n(
...
function ProgramRequirementGuidanceTemplateForm(props) {
    ...
    <FormWrapper>
      <FormProvider {...form}>
        <form onSubmit={form.handleSubmit(onSubmit)}>
          {!isEditing &&
            (modal ? (
              <NewProgramRequirementGuidanceTemplateLayout
                title={title}
                modal
              />
            ) : (
          ...
          {isEditing && (
            <EditProgramRequirementGuidanceTemplateLayout
...
export default ProgramRequirementGuidanceTemplateForm;
