...
const schema = yup.object().shape({
  ...
  totalQuestionsRange: yupFilterSchemas.integerRange(
    i18n(
      'entities.questionnaireTemplate.fields.totalQuestionsRange',
    ),
  ),
});
...
function QuestionnaireTemplateListFilter(props) {
...
export default QuestionnaireTemplateListFilter;
