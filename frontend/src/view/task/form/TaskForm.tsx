...
const schema = yup.object().shape({
  ...
  vendors: yupFormSchemas.relationToMany(
    i18n('entities.task.fields.vendors'),
    {},
  ),
  clients: yupFormSchemas.relationToMany(
    i18n('entities.task.fields.clients'),
    {},
  ),
  ...
  controls: yupFormSchemas.relationToMany(
    i18n('entities.task.fields.controls'),
    {},
  ),
  highlights: yupFormSchemas.relationToMany(
    i18n('entities.task.fields.highlights'),
    {},
  ),
  ...
  projects: yupFormSchemas.relationToMany(
    i18n('entities.task.fields.projects'),
    {},
  ),
