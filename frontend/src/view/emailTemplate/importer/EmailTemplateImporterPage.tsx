...
import actions from 'src/modules/emailTemplate/importer/emailTemplateImporterActions';
...
function EmailTemplateImportPage() {
  const Importer = importerHoc(
    selectors,
    actions,
    fields,
    i18n('entities.emailTemplate.importer.hint'),
  );
