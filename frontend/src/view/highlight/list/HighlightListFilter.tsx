...
const schema = yup.object().shape({
  ...
  createdAtRange: yupFilterSchemas.datetimeRange(
    i18n('entities.highlight.fields.createdAtRange'),
  ),
...
const previewRenders = {
  ...
  createdAtRange: {
    label: i18n('entities.highlight.fields.createdAtRange'),
...
function HighlightListFilter(props) {
              ...
              <Grid container spacing={1.6}>
                ...
                <Grid item lg={6} xs={12}>
                  <DatePickerRangeFormItem
                    name="createdAtRange"
                    label={i18n(
                      'entities.highlight.fields.createdAtRange',
                    )}
                    variant="standard"
                    showTime
                  />
...
HighlightListFilter.defaultProps = {
  additionalFilters: {
    client: null,
    vendor: null,
  },
...
export default HighlightListFilter;
