...
import actions from 'src/modules/highlight/importer/highlightImporterActions';
...
function HighlightImportPage() {
  const Importer = importerHoc(
    selectors,
    actions,
    fields,
    i18n('entities.highlight.importer.hint'),
  );
...
export default HighlightImportPage;
