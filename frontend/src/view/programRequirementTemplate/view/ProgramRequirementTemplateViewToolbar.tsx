...
function ProgramRequirementTemplateViewToolbar(props) {
  ...
  return (
    <ToolbarWrapper>
      {hasPermissionToEdit && (
        <MDButton
          component={Link}
          to={`/program-requirement-template/${id}/edit`}
          variant="gradient"
          color={sidenavColor}
          type="button"
          startIcon={<EditIcon />}
      ...
      <MDButton
        ...
        color={sidenavColor}
        component={Link}
        to={'/program-requirement-template'}
...
export default ProgramRequirementTemplateViewToolbar;
