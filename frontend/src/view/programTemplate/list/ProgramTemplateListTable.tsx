...
function ProgramTemplateListTable(props) {
        ...
        <Table>
          <MDBox component="thead">
            <TableRow>
              ...
              <DataTableHeadCell sorted={false} width="0">
                {i18n(
                  'entities.programTemplate.fields.totalRequirementTemplates',
                )}
              </DataTableHeadCell>
              <DataTableHeadCell sorted={false} width="0">
                {i18n(
                  'entities.programTemplate.fields.totalControlTemplates',
                )}
              </DataTableHeadCell>
                        ...
                        {hasPermissionToEdit && (
                          ...
                          >
                            <IconButton
                              ...
                              color={sidenavColor}
                              component={Link}
                              to={`/program-template/${row.id}/edit`}
                            >
                              <EditIcon />
                            </IconButton>
                          </Tooltip>
...
export default ProgramTemplateListTable;
