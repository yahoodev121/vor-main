...
import actions from 'src/modules/programTemplate/importer/programTemplateImporterActions';
...
function ProgramTemplateImportPage() {
  const Importer = importerHoc(
    selectors,
    actions,
    fields,
    i18n('entities.programTemplate.importer.hint'),
  );
...
export default ProgramTemplateImportPage;
