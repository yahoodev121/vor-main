...
import actions from 'src/modules/vendorCategory/list/vendorCategoryListActions';
...
function VendorCategoryToolbar(props) {
  ...
  const hasPermissionToCreate = useSelector(
    vendorCategorySelectors.selectPermissionToCreate,
  );
  const hasPermissionToImport = useSelector(
    vendorCategorySelectors.selectPermissionToImport,
  );
    ...
    <ToolbarWrapper>
      ...
      {hasPermissionToAuditLogs && (
        <MDButton
          ...
          color={sidenavColor}
          component={Link}
          to="/audit-logs?entityNames=vendorCategory"
...
export default VendorCategoryToolbar;
