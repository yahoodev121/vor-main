...
const schema = yup.object().shape({
  ...
  vendors: yupFormSchemas.relationToMany(
    i18n('entities.risk.fields.vendors'),
    {},
  ),
  clients: yupFormSchemas.relationToMany(
    i18n('entities.risk.fields.clients'),
    {},
  ),
  ...
  controls: yupFormSchemas.relationToMany(
    i18n('entities.risk.fields.controls'),
    {},
  ),
  requirements: yupFormSchemas.relationToManyInRequirements(
    i18n('entities.risk.fields.requirements'),
    {},
  ),
  highlights: yupFormSchemas.relationToMany(
    i18n('entities.risk.fields.highlights'),
    {},
  ),
  ...
  projects: yupFormSchemas.relationToMany(
    i18n('entities.risk.fields.projects'),
    {},
  ),
