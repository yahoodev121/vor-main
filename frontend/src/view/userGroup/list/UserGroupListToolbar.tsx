...
function UserGroupToolbar(props) {
  ...
  const hasPermissionToCreate = useSelector(
    userGroupSelectors.selectPermissionToCreate,
  );
  const hasPermissionToImport = useSelector(
    userGroupSelectors.selectPermissionToImport,
  );
    ...
    <ToolbarWrapper>
      ...
      {hasPermissionToAuditLogs && (
        <MDButton
          ...
          color={sidenavColor}
          component={Link}
          to="/audit-logs?entityNames=userGroup"
