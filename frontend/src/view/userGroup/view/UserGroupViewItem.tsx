...
import selectors from 'src/modules/userGroup/userGroupSelectors';

function UserGroupViewItem(props) {
...
UserGroupViewItem.defaultProps = {
  hiddenLabel: false,
};

UserGroupViewItem.propTypes = {
  hiddenLabel: PropTypes.bool,
  label: PropTypes.string,
  value: PropTypes.any,
};

export default UserGroupViewItem;
