...
import policyVersionsActions from 'src/modules/policy/versions/policyVersionsActions';
...
const policyDestroyActions = {
  ...
  doDestroy: (id) => async (dispatch) => {
    try {
      ...
      const response = await PolicyService.destroyAll([id]);
