...
const selectRaw = (state) => state.policy.versions;
...
const selectPolicy = createSelector([selectRaw], (raw) => {
  return raw.policy;
});
...
export default policyVersionsSelectors;
