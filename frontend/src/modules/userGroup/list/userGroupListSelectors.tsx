...
const selectRaw = (state) => state.userGroup.list;
...
const selectShowAllUserGroups = createSelector(
  [selectRaw],
  (raw) => raw.showAllUserGroups,
);

const userGroupListSelectors = {
  selectLoading,
  selectRows,
  selectCount,
  selectOrderBy,
  ...
  selectIsAllSelected,
  selectSorter,
  selectShowAllUserGroups,
};

export default userGroupListSelectors;
