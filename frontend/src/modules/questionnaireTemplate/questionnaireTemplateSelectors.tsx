...
const selectPermissionToCreate = createSelector(
  ...
  (currentTenant, currentUser) =>
    new PermissionChecker(currentTenant, currentUser).match(
      Permissions.values.questionnaireTemplateCreate,
    ),
);
...
const selectPermissionToImport = createSelector(
  ...
  (currentTenant, currentUser) =>
    new PermissionChecker(currentTenant, currentUser).match(
      Permissions.values.questionnaireTemplateImport,
    ),
);
...
const questionnaireTemplateSelectors = {
...
export default questionnaireTemplateSelectors;
