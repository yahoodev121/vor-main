...
const selectRaw = (state) =>
  state.programRequirementGuidanceTemplate.list;
...
const programRequirementGuidanceTemplateListSelectors = {
  selectLoading,
  selectRows,
  selectCount,
  selectOrderBy,
...
export default programRequirementGuidanceTemplateListSelectors;
