...
export default (state = initialData, { type, payload }) => {
  ...
  if (type === actions.DEACTIVATE_ALL_SELECTED_STARTED) {
    return {
      ...state,
      loading: true,
    };
  ...
  if (type === actions.DEACTIVATE_ALL_SELECTED_ERROR) {
    return {
      ...state,
      loading: false,
    };
  ...
  if (type === actions.DEACTIVATE_ALL_SELECTED_SUCCESS) {
    return {
      ...state,
      selectedKeys: [],
    };
  ...
  if (type === actions.SHOW_ALL_USERS) {
    return {
      ...state,
      showAllUsers: payload,
    };
  }
