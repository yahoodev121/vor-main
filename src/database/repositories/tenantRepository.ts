...
class TenantRepository {
  static async create(data, options: IRepositoryOptions) {
    ...
    await ProjectPriorityRepositoryEx.buildUpDefaultRecords(
      {
        ...options,
        currentTenant: {
          ...record,
    ...
    await ProjectStatusRepositoryEx.buildUpDefaultRecords({
      ...options,
      currentTenant: {
        ...record,
        id: MongooseQueryUtils.ObjectId(record.id),
    ...
    await ProjectTypeRepositoryEx.buildUpDefaultRecords({
      ...options,
      currentTenant: {
        ...record,
        id: MongooseQueryUtils.ObjectId(record.id),
